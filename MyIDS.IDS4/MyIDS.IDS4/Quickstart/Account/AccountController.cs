...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> Login2(string returnUrl)
        {
            // build a model so we know what to show on the login page
            var vm = await BuildLoginViewModelAsync(returnUrl);
        ...
        public async Task<IActionResult> Login2(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // var sc = _signInManager.Context;

                // var v = await _signingCredentialStore.GetSigningCredentialsAsync();
